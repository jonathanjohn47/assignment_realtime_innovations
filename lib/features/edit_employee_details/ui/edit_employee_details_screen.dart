...
import '../get_controllers/edit_employees_get_controller.dart';

class EditEmployeeDetailsScreen extends StatelessWidget {
  const EditEmployeeDetailsScreen({super.key, required this.employeeModel});

  final EmployeeModel employeeModel;

  @override
  Widget build(BuildContext context) {
    EditEmployeesGetController addEmployeesGetController =
        Get.put(EditEmployeesGetController(employeeModel: employeeModel));
    return Scaffold(
      appBar: AppBar(
